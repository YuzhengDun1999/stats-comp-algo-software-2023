...
It cannot guarantee the accuracy of the resulting confidence interval estimates even in the asymtotic regime. It can only guarantee that we found the maximum of log likelihood within tolerance. It did not give any information of the second derivative of the log likelihood function at that point. The confidence interval depends on the Hessian matrix.
## Things to commit/submit

* Link to the pull request.
https://github.com/YuzhengDun1999/hiperglm/pull/2
